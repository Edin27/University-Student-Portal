...
public class ChooseTutorialOrLabForCourseSystemTests extends TUITest {
	...
	@Test
	@DisplayName("check whether the waring message is given when the required " +
			"tutorial count is not match, and whether the tutorial and lab are added " +
			"correctly")
	...
	@Test
	@DisplayName("check whether the waring message is given when the required " +
			"lab count is not match, and whether the tutorial and lab are added " +
			"correctly")
	...
	@Test
	@DisplayName("This test is to check whether an error message is given when " +
			"selecting a specific activity time and selecting a non-existent time.")
	public void testChoose2TutorialsAndLabWhenChooseWrongNum() throws URISyntaxException,
			IOException,
			ParseException {
		// Set up mock inputs for the entire flow
		setMockInput(
